    ...
    <div class="w-full flex flex-wrap">
        ...
        <div class="w-full md:w-1/2 flex flex-col">
            ...
            <div class="flex justify-center md:justify-start pt-12 md:pl-12 md:-mb-12">
                <a href="../../" class="bg-black text-white font-bold text-xl p-4">AfricaGOjr</a>
            </div>
        ...
        <div class="w-1/2 shadow-2xl">
            <img class="object-cover w-full h-screen hidden md:block" src="../images/africa_login.jpg" alt="Background" />
        </div>
    </div>
